...
UIFormMsg* UIFormMsg::ShowStatic(const RtString& text, FormType t, 
								 bool modal, const string& id,bool vDefaultLayer)
{
	guard;
	...
	UIFormMsg* form = RT_NEW UIFormMsg(t, vDefaultLayer ? -1 : 3);//modify by fox for bug//-1就是1，会被清除掉
