...
#ifdef _UNWG_
#   ifdef _DEBUG
#       pragma comment(lib, "NesClient_d.lib")
#   else
#       pragma comment(lib, "NesClient.lib")
#   endif
#endif
...
// Global Variables:
static HINSTANCE        g_hGCInst               = 0;
//static TCHAR            g_szGCTitle[100]        = "FSO Client";
//static TCHAR            g_szGCWindowClass[100]  = "RT3D_FSO_CLIENT";
G_MEMDEF(g_szGCTitle, 100)
G_MEMDEF(g_szGCWindowClass, 100)

static HWND             g_hGCWnd                = 0;
static CRtgAppFrame*    g_pGameClientFrame      = 0;
static RtIni*      g_iniConfig;            // 配置文件 "game.ini" this point never been deleted! louis
static CLogSender		g_LogSender;

bool	g_bLogEnable = false;


//add by yz 2010-6-11:声明函数
void RegisterMemProtector();
//end

// add [3/14/2009 tooth.shi]
//RtgDevice       *g_pDevice		= 0;
GcTimer			*g_pTimer		= 0;
//RtgDevice *g_render = 0;
