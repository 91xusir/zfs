...
BEGIN_CMD_FUNC(cmd_g2c_create_char_ret)
{
	...
	if (result != gws_create_user_okay)
	{
		...
		switch(result)
		{
		default:								errMsg = GcLogin::GLEM_CREATE_RESULT_FAIL;			break;
		case gws_create_user_error:				errMsg = GcLogin::GLEM_CREATE_RESULT_FAIL;			break;
		case gws_create_user_invalid_name:		errMsg = GcLogin::GLEM_CREATE_RESULT_INVALID_NAME;	break;			
		case gws_create_user_duplicate_name:	errMsg = GcLogin::GLEM_CREATE_RESULT_EXIST;			break;
		case gws_create_user_faction_error:		errMsg = GcLogin::GLEM_CREATE_FACTION_ERROR;		break;
		case gws_create_user_banned_name:       errMsg = GcLogin::GLEM_CREATE_BANNED_NAME;          break;
		}
