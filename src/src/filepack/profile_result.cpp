...
#include "filepack/profile_result.h"
#include <string>
...
#ifdef WIN32
    nBuf += _vsnprintf(szBuffer+nBuf,MAX_BUFFER_SIZE-nBuf,format, args);
#else // linux
    nBuf += vsnprintf(szBuffer+nBuf,MAX_BUFFER_SIZE-nBuf,format, args);
#endif	
