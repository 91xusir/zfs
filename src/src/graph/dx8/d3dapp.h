...
{
private:
    static DWORD        _m_dwStatTimerRun;
    static DWORD        _m_dwStatTimerRender;
    static DWORD        _m_dwStatTimerPresent;
...
protected:
    ...
    DWORD               m_dwStatTimerRun;
    DWORD               m_dwStatTimerRender;
    DWORD               m_dwStatTimerPresent;
...
protected:
    ...
    virtual bool OnD3D8ErrorMessage(const char* szMsg, int iType) { return false; }
public:
    ...
    unsigned int m_eMaxMultiSampleTypeWindowed;
    unsigned int m_eMaxMultiSampleTypeFullscreen;
