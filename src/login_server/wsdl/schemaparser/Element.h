...
inline
void
Element::setTypeNamespace(std::string ns)
{
  elemTypeNamespace = ns;
}
...
Element::operator = (const Element & e)
{
  ...
  dval = e.dval;
  fval = e.fval;
    elemTypeNamespace = e.elemTypeNamespace;
  cstr = e.cstr;
  return *this;
