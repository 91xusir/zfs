...
class CScriptEngine {
   public:
    ...
    // build int
    //
    void BuildArg(PyObject* args, int index, int arg) {
        BuildArg(args, index, Py_BuildValue("i", arg));
    }

    //
    // build int
    //
    void BuildArg(PyObject* args, int index, unsigned int arg) {
        BuildArg(args, index, static_cast<int>(arg));
    }

    //
    // build long
    //
    void BuildArg(PyObject* args, int index, long arg) {
        BuildArg(args, index, Py_BuildValue("l", arg));
    }

    //
    // build long
    //
    void BuildArg(PyObject* args, int index, unsigned long arg) {
        BuildArg(args, index, static_cast<long>(arg));
    }

    //
    // build string
    //
    void BuildArg(PyObject* args, int index, char const* arg) {
        BuildArg(args, index, Py_BuildValue("s", arg));
    }

    //
    // build float
    //
    void BuildArg(PyObject* args, int index, float arg) {
        BuildArg(args, index, Py_BuildValue("f", arg));
    }

    //
    // build region object
    //
    void BuildArg(PyObject* args, int index, CRegionObject* arg) {
        BuildArg(args, index, CreatePythonObject(arg));
    }
