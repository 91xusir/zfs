...
constexpr int NET_PACKET_HEAD_SIZE      = 5 + 2;
constexpr int NET_PACKET_ENCRYPT_OFFSET = 3 + 2;
constexpr int MAX_NET_PACKET_SIZE =
    MAX_CMD_PACKET_SIZE + NET_PACKET_HEAD_SIZE + MAX_BIT_MSG_SIZE / 8;
...
class CG_NetPacket {
   public:
    CG_NetPacket();
    CG_NetPacket(const CG_NetPacket& object);
