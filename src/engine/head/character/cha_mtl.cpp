...
CRT_MtlStandard::CRT_MtlStandard()
    : m_delta(0), m_bUseFrame(false), m_bMask(false), m_bTwoSide(false), m_bAlpha(false),
      m_alphaType(ALPHA_BLEND), m_visible(1.f), m_visibleGlobal(1.f), m_visibleLocal(1.f),
      m_amb(1.f, 1.f, 1.f, 1.f), m_dif(1.f, 1.f, 1.f, 1.f), m_emi(0.f, 0.f, 0.f, 0.f),
      m_spe(0.f, 0.f, 0.f, 0.f), m_bSpec(false), m_spePower(0.f), m_bTexMatrix(false),
      m_baseRotate(0.f, 0.f, 0.f), m_baseTranslate(0.f, 0.f, 0.f), m_baseScale(0.f, 0.f, 0.f),
      m_rtAmb(1.f, 1.f, 1.f, 1.f), m_rtDif(1.f, 1.f, 1.f, 1.f), m_rtEmi(0.f, 0.f, 0.f, 0.f),
      m_rtBaseEmi(0.f, 0.f, 0.f, 0.f), m_rtVisible(1.f) {
...
bool CRT_MtlStandard::Create() {
    if (m_ro.iNumStage)
        m_ro.Shaders[0].SetTexture(
            RtGetRender()->GetTextMgr()->CreateTextureFromFile_Direct(m_texPath));

    return true;
}

void CRT_MtlStandard::Tick(float deltaMill) {
...
long CRT_MtlStandard::Serialize(RtArchive& Ar) {
    Ar << m_name << m_bUseFrame << m_bMask << m_bTwoSide << m_bAlpha << m_alphaOpt << m_visible
       << m_amb << m_dif << m_emi << m_bSpec << m_spe << m_spePower << m_texture << m_bTexMatrix
       << m_baseRotate << m_baseTranslate << m_baseScale << m_keyList;
...
CRT_MtlMu::CRT_MtlMu()
    : m_color(1.f, 1.f, 1.f), m_colorType(OP_MODULATE), m_delta(0), m_bUseFrame(false),
      m_bMask(false), m_bTwoSide(false), m_bAlpha(false), m_alphaType(ALPHA_BLEND), m_visible(1.f),
      m_visibleGlobal(1.f), m_visibleLocal(1.f), m_amb(1.f, 1.f, 1.f, 1.f),
      m_dif(1.f, 1.f, 1.f, 1.f), m_emi(0.f, 0.f, 0.f, 0.f), m_rtAmb(1.f, 1.f, 1.f, 1.f),
      m_rtDif(1.f, 1.f, 1.f, 1.f), m_rtEmi(0.f, 0.f, 0.f, 0.f), m_rtVisible(1.f),
...
long CRT_MtlMu::Serialize(RtArchive& Ar) {
    Ar << m_name << m_bUseFrame << m_bMask << m_bTwoSide << m_bAlpha << m_alphaOpt << m_visible
       << m_amb << m_dif << m_emi << m_colorOpt << m_uvOpt << m_texBase << m_texSpec << m_keyList;
...
bool CRT_MtlBlend::Apply(RtgDevice* _Dev) {
    ...
    for (int i = 0; i < MAX_BLEND_CHANNEL; ++i) {
        ...
        m_ro.eBlendSrcFunc = RTGBLEND_SRCALPHA;
        m_ro.eBlendDstFunc = RTGBLEND_INVSRCALPHA;
        m_ro.dwTextureFactor =
            RtgVectorToColor(RtgVertex3(1, 1, 1), m_rtVisible * m_channel[i].Weight);
