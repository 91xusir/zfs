...
public:
    bool Init(RTHINSTANCE hInst, RtRuntimeClass* pEventClass, RtRuntimeClass* pCameraClass, const char* szGraphIni, const char* szUserIni);
    bool Init(RTHINSTANCE hInst, RtRuntimeClass* pEventClass, RtRuntimeClass* pCameraClass, RtIni* pGraphIni, RtIni* pUserIni);
    ...
    void SetViewWindowInfo(RTGViewWindowMode eMode, DWORD dwWidth, DWORD dwHeight, DWORD dwDepth, DWORD dwRefreshRate);
...
public:
    ...
    virtual BOOL ClearRenderTarget(bool bStencil=false, bool bTarget=true, bool bZBuffer=true, DWORD dwColor=0x00000000, float fNewZ=1.f, DWORD dwStencil=0)=0;
...
----------------------------------------------------------------------*/
    ...
    virtual BOOL SetMaterial(RtgVertex4& vDiffuse, RtgVertex4& vAmbient, RtgVertex4& vSpecular, RtgVertex4& vEmissive, float fPower=0.f)=0;
...
----------------------------------------------------------------------*/
    ...
    void SetPostProcessObjectHighLightOnoff(bool bOn) { m_bUsePostProcessObjectHighLightOnoff = bOn; }
...
public:
    ...
    struct SConfig
    {
		...
		SConfig(const SConfig &object)
		{
			CM_MEMPROTECTOR(szWindowTitle, 256)
		}
		~SConfig()
		{
			CM_MEMUNPROTECTOR(szWindowTitle)
		}
    };
