...
int AzothParseIniFile(const char* szFilename, TypeCallbackAzothIniError callbackIniError, TypeCallbackAzothIniParser callbackParserIni, void *arg)
{
	int retval;
	s_azoth_file file;
	s_azoth_ini_parser_param ini_parser_param;

	ini_parser_param.callbackParser = callbackParserIni;
	ini_parser_param.callbackError = callbackIniError;
	ini_parser_param.arg = arg;
	AZ_PARSER(ini_parser_param) = &ini_parser_param;

	file.szFilename = strdup(szFilename);
	file.bInitFilename = 1;
	file.pArc = 0;

	retval = azini_open_file_for_scanning(&file);
    if (retval==0)
	{
		return -1;
	}
	retval = azini_parse();
	azini_close_file(&file);
...
static void azini_error(char *str)
{
	...
	{
		AZ_PARSER(ini_parser_param)->callbackError(azini_scanner_get_filename(), str, azini_scanner_get_lineno(), AZ_PARSER(ini_parser_param)->arg);
	}
}

void AzothIniDoOperate(char cOpType, azoth_value *pResult, azoth_value *pOperate1, azoth_value *pOperate2)
{
...
{
	AZ_PARSER(ini_parser_param)->callbackParser(arg1, arg2, callback_type, AZ_PARSER(ini_parser_param)->arg);
}
...
static const short yyprhs[] = {     0,
    ...
    22,    24,    26,    28,    30,    32,    36,    40,    43,    46,
    50
};

static const short yyrhs[] = {    18,
    19,     0,     0,     3,    13,    20,     0,     3,     0,     8,
     0,    14,     0,    22,     0,    21,     0,     7,     0,     4,
     0,     5,     0,     6,     0,    14,     0,    15,     0,     4,
     0,    21,     9,    21,     0,    21,    10,    21,     0,    11,
    21,     0,    12,    21,     0,    16,    21,    17,     0,     3,
     0
};
...
static const short yyrline[] = { 0,
   102,   104,   107,   114,   115,   116,   119,   121,   122,   123,
   124,   125,   126,   127,   130,   132,   133,   134,   135,   136,
   139
};

static const char * const yytname[] = {   "$","error","$undefined.","INI_STRING",
"INI_BOOL","INI_LONG","INI_DOUBLE","INI_ENCAPSULATED_STRING","INI_SECTION","'|'",
"'&'","'~'","'!'","'='","'\\n'","'000'","'('","')'","statement_list","statement",
"string_or_value","expr","constant_string",""
};
#endif
...
static const short yydefact[] = {     2,
     0,     4,     5,     6,     1,     0,    21,    10,    11,    12,
     9,     0,     0,    13,    14,     0,     3,     8,     7,    15,
    18,    19,     0,     0,     0,    20,    16,    17,     0,     0
};
...
static const short yypact[] = {-32768,
     0,    -7,-32768,-32768,-32768,     6,-32768,    -8,-32768,-32768,
-32768,    19,    19,-32768,-32768,    19,-32768,    -5,-32768,-32768,
-32768,-32768,    15,    19,    19,-32768,-32768,-32768,     7,-32768
};
...
static const short yytable[] = {    29,
   -15,   -15,     2,    24,    25,     6,    30,     3,     7,     8,
     9,    10,    11,     4,    21,    22,    12,    13,    23,    14,
    15,    16,    20,    24,    25,     0,    27,    28,     0,    12,
    13,    26,     0,     0,    16
};

static const short yycheck[] = {     0,
     9,    10,     3,     9,    10,    13,     0,     8,     3,     4,
     5,     6,     7,    14,    12,    13,    11,    12,    16,    14,
    15,    16,     4,     9,    10,    -1,    24,    25,    -1,    11,
    12,    17,    -1,    -1,    16
};
#define YYPURE 1
