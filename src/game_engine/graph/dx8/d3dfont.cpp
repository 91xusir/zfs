...
HRESULT CD3DFont::InitDeviceObjects( LPDIRECT3DDEVICE8 pd3dDevice )
{
    ...
    HBITMAP hOldBit = (HBITMAP)SelectObject( hDC, hbmBitmap );
...
HRESULT CD3DFont::RestoreDeviceObjects()
{
    ...
    for( UINT which=0; which<2; which++ )
    {
        ...
        m_pd3dDevice->SetTextureStageState( 0, D3DTSS_COLORARG0, D3DTA_DIFFUSE );
        m_pd3dDevice->SetTextureStageState( 0, D3DTSS_ALPHAOP,   D3DTOP_MODULATE );
        m_pd3dDevice->SetTextureStageState( 0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE );
        m_pd3dDevice->SetTextureStageState( 0, D3DTSS_ALPHAARG2, D3DTA_DIFFUSE );
        m_pd3dDevice->SetTextureStageState( 0, D3DTSS_ALPHAARG0, D3DTA_DIFFUSE );
