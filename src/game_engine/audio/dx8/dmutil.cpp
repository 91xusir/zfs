...
//-----------------------------------------------------------------------------
// Name: DXUtil_ConvertAnsiStringToWide_mycopy()
// Desc: This is a UNICODE conversion utility to convert a CHAR string into a
//       WCHAR string. cchDestChar defaults -1 which means it 
//       assumes strDest is large enough to store strSource
//-----------------------------------------------------------------------------
VOID DXUtil_ConvertAnsiStringToWide_mycopy( WCHAR* wstrDestination, const CHAR* strSource, 
                                    int cchDestChar = -1 )
{
...
//-----------------------------------------------------------------------------
// Name: DXUtil_ConvertGenericStringToWide_mycopy()
// Desc: This is a UNICODE conversion utility to convert a TCHAR string into a
//       WCHAR string. cchDestChar defaults -1 which means it 
//       assumes strDest is large enough to store strSource
//-----------------------------------------------------------------------------
VOID DXUtil_ConvertGenericStringToWide_mycopy( WCHAR* wstrDestination, const TCHAR* tstrSource, 
                                       int cchDestChar = -1 )
{
...
#else
    DXUtil_ConvertAnsiStringToWide_mycopy( wstrDestination, tstrSource, cchDestChar );
#endif
}
...
HRESULT CMusicManager::SetSearchDirectory( const TCHAR* strMediaPath )
{
    ...
    DXUtil_ConvertGenericStringToWide_mycopy( wstrMediaPath, strMediaPath );
                                              ...
                                              BOOL bIsMidiFile )
{
    ...
    DXUtil_ConvertGenericStringToWide_mycopy( wstrFileName, strFileName );
    ...
    *ppSegment = RT_NEW CMusicSegment( m_pPerformance, m_pLoader, pSegment );
    if (!*ppSegment)
                                             ...
                                             TCHAR* strFileName )
{
    ...
    *ppScript = RT_NEW CMusicScript( m_pPerformance, m_pLoader, pScript );
    if (!*ppScript)
        return E_OUTOFMEMORY;
...
{       
    ...
    if( pStyle )
    {
        ...
        DXUtil_ConvertGenericStringToWide_mycopy( wstrMotif, strMotif );
...
HRESULT CMusicScript::CallRoutine( TCHAR* strRoutine )
{
    ...
    DXUtil_ConvertGenericStringToWide_mycopy( wstrRoutine, strRoutine );
...
HRESULT CMusicScript::SetVariableNumber( TCHAR* strVariable, LONG lValue )
{
    ...
    DXUtil_ConvertGenericStringToWide_mycopy( wstrVariable, strVariable );
