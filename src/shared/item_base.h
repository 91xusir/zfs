...
extern G_MEMDEF(g_strItemBuffer4096, 4096) extern G_MEMDEF(
    g_strItemBuffer10240,
    10240) extern G_MEMDEF(g_strItemBuffer20480,
                           20480) extern G_MEMDEF(g_strItemBuffer256,
                                                  256) extern G_MEMDEF(g_strItemBufferBD, 256)
...
#define ITEM_MASK_GEM_LUCK_7ONLY                                                                   \
    0x5b000000  // 使+7的成功率提高到50% // 2006.6.27 变更为：改版后神佑天晶精炼对应为+7+8+9，成功几率提升到70%
...
inline bool ItemBind_IsValid(BYTE cBind) {
    return (cBind == IB_NotBind || cBind == IB_Binded || cBind == IB_BindWhenPick ||
            cBind == IB_BindWhenEquip);
}
...
/*目前已不使用*/ bool
ItemID_HaveParams(DWORD type);  // 判断一种类型的道具是否含有参数(即params是否有值)
...
/// Helper Functions:
// 一级分类
inline BOOL ItemIsWeapon(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_WEAPON);
}

inline BOOL ItemIsArmor(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_ARMOR);
}

inline BOOL ItemIsGem(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_GEM);
}

inline BOOL ItemIsScroll(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_SCROLL);
}

inline BOOL ItemIsYaoPing(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_YAOPING);
}

inline BOOL ItemIsShipin(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_SHIPIN);
}

inline BOOL ItemIsOther(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_OTHER ||
            (id.type & ITEM_MASK_TYPE) == ITEM_MASK_OTHER2);
}

inline BOOL ItemIsPet(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_PET);
}

inline BOOL ItemIsSkill(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_SKILL);
}

inline BOOL ItemIsTrump(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_TRUMP);
}

inline BOOL ItemIsFashion(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_FASHION);
}

inline BOOL ItemIsSorption(SItemID& id) {
    return ((id.type & ITEM_MASK_TYPE) == ITEM_MASK_SORPTION);
}

// 武器二级分类
inline BOOL ItemIsWeapon_Pestle(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_PESTLE);
}

inline BOOL ItemIsWeapon_Axe(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_AXE);
}

inline BOOL ItemIsWeapon_Riband(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_RIBAND);
}

inline BOOL ItemIsWeapon_Hoop(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_HOOP);
}

inline BOOL ItemIsWeapon_Ball(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_BALL);
}

inline BOOL ItemIsWeapon_Sword(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_SWORD);
}

inline BOOL ItemIsWeapon_Wheel(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_WHEEL);
}

inline BOOL ItemIsWeapon_Wand(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_WAND);
}

inline BOOL ItemIsShield(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_SHIELD);
}

inline BOOL ItemIsMineEquip(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_MINING);
}

inline BOOL ItemIsHerbalEquip(SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_HERBALISM);
}

inline BOOL ItemIsWeapon_Pestle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_PESTLE);
}

inline BOOL ItemIsWeapon_Axe(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_AXE);
}

inline BOOL ItemIsWeapon_Riband(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_RIBAND);
}

inline BOOL ItemIsWeapon_Hoop(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_HOOP);
}

inline BOOL ItemIsWeapon_Ball(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_BALL);
}

inline BOOL ItemIsWeapon_Sword(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_SWORD);
}

inline BOOL ItemIsWeapon_Wheel(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_WHEEL);
}

inline BOOL ItemIsWeapon_Wand(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_WAND);
}

inline BOOL ItemIsShield(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_SHIELD);
}

inline BOOL ItemIsMineEquip(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_MINING);
}

inline BOOL ItemIsHerbalEquip(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_HERBALISM);
}
...
inline BOOL ItemIsWeapon_NeedLink(SItemID& id) {
    return (ItemIsWeapon_Pestle(id) || ItemIsWeapon_Axe(id) || ItemIsWeapon_Hoop(id) ||
            ItemIsWeapon_Wand(id) || ItemIsWeapon_Riband(id));
}

inline BOOL ItemIsCaestus(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_ARMOR_CAESTUS);
}

inline BOOL ItemIsCloth(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_ARMOR_CLOTH);
}

inline BOOL ItemIsGlove(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_ARMOR_GLOVE);
}

inline BOOL ItemIsShoes(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_ARMOR_SHOES);
}

inline BOOL ItemIsRing(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SHIPIN_RING);
}

inline BOOL ItemIsNecklace(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SHIPIN_NECKLACE);
}

inline BOOL ItemIsKits(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SHIPIN_KITS);
}

inline BOOL ItemIsBook(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SHIPIN_BOOK);
}

inline BOOL ItemIsFly(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SHIPIN_FLY);
}

inline BOOL ItemIsHPBottle(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_HP);
}

inline BOOL ItemIsMPBottle(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_MP);
}

inline BOOL ItemIsEXPBottle(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_EXP);
}

inline BOOL ItemIsCardMinuteBottle(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_CARDMINUTE);
}

inline BOOL ItemIsBow(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_WEAPON_RIBAND);
}

inline BOOL ItemIsPetHpBottle(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_PETHP);
}

inline BOOL ItemIsPetMpBottle(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_PETMP);
}

inline BOOL ItemIsEnergyBottle(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_ENERGY);
}

inline BOOL ItemIsGemMagic(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_MAGIC);
}

inline BOOL ItemIsGemWeapon1(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_WEAPON1);
}

inline BOOL ItemIsGemWeapon2(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_WEAPON2);
}

inline BOOL ItemIsGemWeapon3(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_WEAPON3);
}

inline BOOL ItemIsGemArmor1(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_ARMOR1);
}

inline BOOL ItemIsGemArmor2(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_ARMOR2);
}

inline BOOL ItemIsGemArmor3(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_ARMOR3);
}

inline BOOL ItemIsGemLuck2(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_LUCK2);
}

inline BOOL ItemIsGemLuck3(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_LUCK3);
}

inline BOOL ItemIsGemLuck6Only(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_LUCK_6ONLY);
}

inline BOOL ItemIsGemLuck7Only(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_LUCK_7ONLY);
}

inline BOOL ItemIsGemAntiBroken(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_GEM_ANTIBROKEN);
}

inline BOOL ItemIsGemWeapon(const SItemID& id) {
    DWORD tmp = id.type & ITEM_MASK_SUBTYPE;
    if (tmp == ITEM_MASK_GEM_WEAPON1 || tmp == ITEM_MASK_GEM_WEAPON2 ||
        tmp == ITEM_MASK_GEM_WEAPON3)
        return 1;
    else
        return 0;
}
...
inline BOOL ItemIsGemLuck(const SItemID& id) {
    DWORD tmp = id.type & ITEM_MASK_SUBTYPE;
    if (tmp == ITEM_MASK_GEM_LUCK2 || tmp == ITEM_MASK_GEM_LUCK3 ||
        tmp == ITEM_MASK_GEM_LUCK_6ONLY || tmp == ITEM_MASK_GEM_LUCK_7ONLY)
        return 1;
    else
        return 0;
}

inline BOOL ItemIsPetNormal(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_PET_NORMAL);
}

inline BOOL ItemIsPetFairy(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_PET_FAIRY);
}

inline BOOL ItemIsPetSpectre(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_PET_SPECTRE);
}

inline BOOL ItemIsSorptionTrump(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SORPTION_TRUMP);
}

inline BOOL ItemIsSorptionPet(const SItemID& id) {
    return ((id.type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SORPTION_PET);
}

inline BOOL ItemIsScrollHome(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SCROLL_HOME);
}

inline BOOL ItemIsScrollCompose(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SCROLL_COMPOSE);
}

inline BOOL ItemIsScrollEnchant(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SCROLL_ENCHANT);
}

inline BOOL ItemIsWeapon(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_WEAPON);
}

inline BOOL ItemIsArmor(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_ARMOR);
}

inline BOOL ItemIsGem(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_GEM);
}

inline BOOL ItemIsScroll(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_SCROLL);
}

inline BOOL ItemIsYaoPing(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_YAOPING);
}

inline BOOL ItemIsShipin(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_SHIPIN);
}

inline BOOL ItemIsOther(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_OTHER) ||
           ((type & ITEM_MASK_TYPE) == ITEM_MASK_OTHER2);
}

inline BOOL ItemIsPet(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_PET);
}

inline BOOL ItemIsSkill(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_SKILL);
}

inline BOOL ItemIsTrump(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_TRUMP);
}

inline BOOL ItemIsFashion(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_FASHION);
}

inline BOOL ItemIsSorption(DWORD type) {
    return ((type & ITEM_MASK_TYPE) == ITEM_MASK_SORPTION);
}

inline BOOL ItemIsHPBottle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_HP);
}

inline BOOL ItemIsMPBottle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_MP);
}

inline BOOL ItemIsEXPBottle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_EXP);
}

inline BOOL ItemIsCardMinuteBottle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_CARDMINUTE);
}

inline BOOL ItemIsEnergyBottle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_ENERGY);
}

inline BOOL ItemIsPetHpBottle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_PETHP);
}

inline BOOL ItemIsPetMpBottle(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_YAOPING_PETMP);
}

inline BOOL ItemIsOther_Task(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_TASK);
}

inline BOOL ItemIsOther_Magic(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_MAGIC);
}

inline BOOL ItemIsOther_Flag(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_FLAG);
}

inline BOOL ItemIsOther_Effect(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_EFFECT);
}

inline BOOL ItemIsOther_Dungeon(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_DUNGEON);
}

inline BOOL ItemIsOther_ClearStr(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_CLEAR_STR);
}

inline BOOL ItemIsOther_ClearDex(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_CLEAR_DEX);
}

inline BOOL ItemIsOther_ClearHit(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_CLEAR_HIT);
}

inline BOOL ItemIsOther_ClearCon(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_CLEAR_CON);
}

inline BOOL ItemIsOther_ClearInt(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_CLEAR_INT);
}

inline BOOL ItemIsOther_ClearSkill(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_CLEAR_SKILL);
}

inline BOOL ItemIsOther_Spawn(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER2_SPAWN);
}

inline BOOL ItemIsOther_NwTeleport(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER2_NW_TELEPORT);
}

inline BOOL ItemIsOther_NwCallTeam(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER2_NW_CALLTEAM);
}

inline BOOL ItemIsOther_NwSkill(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER2_NW_SKILL);
}

inline BOOL ItemIsOther_BankExtend(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER_BANKEXTEND);
}

inline BOOL ItemIsOther_Hero(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_OTHER2_HERO);
}

inline BOOL ItemCanDelete(const SItemID& id) {
    return (id.type & ITEM_MASK_CAN_DELETE);
}

inline BOOL ItemCanDrop(const SItemID& id) {
    return (id.type & ITEM_MASK_CAN_DROP);
}

inline BOOL ItemIsMissionItem(const SItemID& id) {
    return (id.type & ITEM_MASK_MISSION_ITEM);
}

inline BOOL ItemCanTrade(const SItemID& id) {
    return (id.type & ITEM_MASK_CAN_TRADE);
}

inline BOOL ItemCanPile(const SItemID& id) {
    return (id.type & ITEM_MASK_CAN_PILE);
}

inline BOOL ItemCanUpdate(const SItemID& id) {
    return (id.type & ITEM_MASK_CAN_UPDATE);
}

inline BOOL ItemCanNpcTrade(const SItemID& id) {
    return (id.type & ITEM_MASK_CAN_NPCTRADE);
}

inline BOOL ItemCanDelete(DWORD type) {
    return (type & ITEM_MASK_CAN_DELETE);
}

inline BOOL ItemCanDrop(DWORD type) {
    return (type & ITEM_MASK_CAN_DROP);
}

inline BOOL ItemIsMissionItem(DWORD type) {
    return (type & ITEM_MASK_MISSION_ITEM);
}

inline BOOL ItemCanTrade(DWORD type) {
    return (type & ITEM_MASK_CAN_TRADE);
}

inline BOOL ItemCanPile(DWORD type) {
    return (type & ITEM_MASK_CAN_PILE);
}

inline BOOL ItemCanUpdate(DWORD type) {
    return (type & ITEM_MASK_CAN_UPDATE);
}

inline BOOL ItemCanNpcTrade(DWORD type) {
    return (type & ITEM_MASK_CAN_NPCTRADE);
}

inline BOOL ItemIsWhite(const SItemID& id) {
    return (id.color == ItemColor_White);
}

inline BOOL ItemIsGreen(const SItemID& id) {
    return (id.color == ItemColor_Green);
}

inline BOOL ItemIsBlue(const SItemID& id) {
    return (id.color == ItemColor_Blue);
}

inline BOOL ItemIsGolden(const SItemID& id) {
    return (id.color == ItemColor_Golden);
}

inline bool ItemID_IsValid(const SItemID& id) {
    return !(id.id == 0 || id.type == 0);
}

inline void ItemID_SetInvalid(SItemID& id) {
    id.Clear();
}

inline SItemID ItemID_CreateInvalid() {
    SItemID id;
    return id;
}

inline BOOL ItemIsPetNormal(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_PET_NORMAL);
}

inline BOOL ItemIsPetFairy(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_PET_FAIRY);
}

inline BOOL ItemIsPetSpectre(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_PET_SPECTRE);
}

inline BOOL ItemIsSorptionTrump(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SORPTION_TRUMP);
}

inline BOOL ItemIsSorptionPet(DWORD type) {
    return ((type & ITEM_MASK_SUBTYPE) == ITEM_MASK_SORPTION_PET);
}
...
inline bool ItemComposeType_IsValid(EItemComposeType ict) {
    return (ict > 0 && ict < ICT_Count);
}
...
struct SItemCompose {
    ...
    SItemCompose(void){
        CM_MEMPROTECTOR(Name, PATH_STRING_LEN)
            CM_MEMPROTECTOR(Desc, DESC_STRING_LEN)} SItemCompose(const SItemCompose& object) {
...
class CItemComposeMgr {
   public:
    ...
    bool          CheckCompose(DWORD ComposeId, CItemContainerBase* pItemContainer,
...
#define ITEM_MAX_GRADE_COUNT 99
   ...
   private:
    ...
    EXT_SPACE::unordered_map<WORD, std::vector<SAttribAddtion>>
        m_attribs;  // ID(AttribID)到SAttribAddtion的映射
};
...
class CItemSelectionTable {
   public:
    ...
    void Explain_ItemSelectionType(EItemSelectionType ist, int& outType, int& outSubType,
                                   int& metier, std::string& str);
    void Explain_ItemSelectionLevel(EItemSelectionLevel isl, int& outLevelFrom, int& outLevelTo,
                                    std::string& str);
...
class CItemManager {
   public:
    ...
    SItemID    CreateItem(RtString name, EItemColor color = ItemColor_White, BYTE level = 0,
                          EItemBind cBind = IB_NotBind, WORD ColorAttribID1 = 0, BYTE ColorRate1 = 0,
                          WORD ColorAttribID2 = 0, BYTE ColorRate2 = 0,
                          DWORD TimeLimit = 0);  // 根据名字创建
    SItemID    CreateItem(DWORD index, EItemColor color = ItemColor_White, BYTE level = 0,
                          EItemBind cBind = IB_NotBind, WORD ColorAttribID1 = 0, BYTE ColorRate1 = 0,
                          WORD ColorAttribID2 = 0, BYTE ColorRate2 = 0,
                          DWORD TimeLimit = 0);  // 根据表格中物品ID创建
    ...
    bool    GenerateCreateString(std::vector<SCreateItem>& arrCreateItem,
                                 std::string&              outCreateString);
    bool    AnalyseCreateString(std::string&              CreateString,
                                std::vector<SCreateItem>& outArrayCreateItem);
    SItemID CreateItemByStruct(SCreateItem& ci);

    // 注入蓝金属性
    bool InfuseColor(SItemID& item, EItemColor color, WORD attribID1 = 0, BYTE ColorRate1 = 0,
                     WORD attribID2 = 0, BYTE ColorRate2 = 0);
   ...
   private:
    SItemID _CreateItem(DWORD type, SItemBase* pBase, EItemColor color = ItemColor_White,
                        BYTE level = 0, EItemBind cBind = IB_NotBind, WORD ColorAttribID1 = 0,
                        BYTE ColorRate1 = 0, WORD ColorAttribID2 = 0, BYTE ColorRate2 = 0,
                        DWORD TimeLimit = 0);
...
#define MAX_PILE_COUNT 255  //9		// 每个格子可容纳的可堆叠物品的数量
   ...
   public:
    ...
    {
        if (m_nItemCount == m_nPageCount * m_nLineCount * m_nColumnCount)
            return true;
        else
            return false;
    }
    ...
    int FreeSpace() const {
        return (m_nPageCount * m_nLineCount * m_nColumnCount - m_nItemCount);
    }  // 剩余容量

    int  GetVisibleMaxLine() const;  // 有道具存在的最大行
    void Clear();                    // 清空容器
    void ItemUpdateQuickSort(std::vector<SItemID>& item, int left,
    ...
    bool MoveToBag(CBag* pToBag,
                   DWORD typeMask = 0xffffffff);  // 把此容器中的所有物品移动到另外一个容器中
    bool MoveToContainer(CItemContainerBase* pCon, DWORD typeMask = 0xffffffff);
    bool AddToBag(CBag* pToBag,
                  DWORD typeMask = 0xffffffff) const;  // 把此容器中的所有物品添加到另外一个容器中
    ...
    bool RemoveFromArray(
        vector<SItemID>& arrItems);  // array中的所有物品，如果在对象中存在，就把它删除掉
    bool
    RemoveFromArray(vector<DWORD>& arrItemID);  // array中的所有物品，如果在对象中存在，就把它删除掉
    ...
    bool Find(SItemID itemID, int* pOutPage = NULL, int* pOutI = NULL,
              int* pOutJ = NULL) const;  // 查找一个物品(SItemID)
    bool Find(DWORD ID, int* pOutPage = NULL, int* pOutI = NULL,
              int* pOutJ = NULL) const;  // 查找一个物品(SItemID.id)
    bool FindType(DWORD typeID, EItemColor color = ItemColor_All, int* pOutCount = NULL,
                  int* pOutPage = NULL, int* pOutI = NULL,
                  int* pOutJ = NULL) const;  // 查找一种类型的物品的数量
    bool FindTypeWithParams(
        DWORD typeID, std::vector<DWORD>& paramsIndices, std::vector<DWORD>& paramsCheck,
        EItemColor color = ItemColor_All, int* pOutCount = NULL, int* pOutPage = NULL,
        int* pOutI = NULL,
        int* pOutJ = NULL) const;  // 查找一种类型的物品(可以查找道具特定的参数)的数量
    bool FindID(DWORD ID, int* pOutPage = NULL, int* pOutI = NULL,
                int* pOutJ = NULL) const;                // 查找一个物品(SItemID.id)
    ...
    bool ResolveItem(int fromPage, int fromI, int fromJ, int toPage, int toI, int toJ,
                     int Num);  //Tianh 分离物品
    bool AddItem(SItemID& id, int* pOutPage = NULL, int* pOutI = NULL, int* pOutJ = NULL,
                 bool bPileIfPossible = true);  // 把一个道具添加到此容器中,放到第一个适合的格子中
    bool SetItem(int i, int j,
                 SItemID id);  // 不管原来格子中是否有物品，都清除掉原来的，并设置为新物品
    bool AddItem(int i, int j, SItemID id);  // 如果原来格子中有物品并且有数量属性，则增加
    //bool        SetItem(int i, int j, int Num); //Tianh 10.03.12 用来分离物品
    long GetNumBytype(DWORD type,
                      WORD cBind);  //Tianh 得到这个类型的所有物品的总数量  区分绑定和不绑定
    void SetSell(DWORD type, WORD cBind, long num);  //Tianh  卖物品的特殊处理

    //Tianh     物品分离
    bool    ResolveItem(CBag* fromContainer, int fromPage, int fromI, int fromJ, CBag* toContainer,
    ...
    bool    RemoveItem(DWORD typeID, EItemColor color = ItemColor_All,
                       int count = -1);  // 删除此种类型的count个数的物品(如果count=-1,则删除所有)
    bool
         RemoveItemWithParams(DWORD typeID, std::vector<DWORD>& paramsIndices,
                              std::vector<DWORD>& paramsCheck, EItemColor color = ItemColor_All,
                              int count = -1);  // 删除此种类型的count个数的物品(如果count=-1,则删除所有)
    bool MoveItem(int fromPage, int fromI, int fromJ, int toPage, int toI, int toJ);
    bool MoveItem(CBag* fromContainer, int fromPage, int fromI, int fromJ, CBag* toContainer,
    ...
    void SetPageIndex(int page) {
        if (m_nCurrentPage >= 0 && m_nCurrentPage < m_nPageCount)
            m_nCurrentPage = page;
    }

    bool _IsValidIndex(int i, int j) const {
        return (i >= 0 && i < m_nLineCount && j >= 0 && j < m_nColumnCount);
    }

    bool _IsValidIndex(int page, int i, int j) const {
        return (page >= 0 && page < m_nPageCount && i >= 0 && i < m_nLineCount && j >= 0 &&
                j < m_nColumnCount);
    }
    ...
    bool GetVisible(int page, int i, int j) const {
        return (m_AssistantAttrib[page][i][j] >> IAA_Visible) & 0x01;
    }
    ...
    bool GetLock(int page, int i, int j) const {
        return (m_AssistantAttrib[page][i][j] >> IAA_Lock) & 0x01;
    }
   ...
   private:
    ...
    long    m_nMoney;
    long    m_nPoint;
    SItemID m_nItemID[MAX_BAG_PAGE_COUNT][MAX_BAG_LINE_COUNT]
                     [MAX_BAG_COLUMN_COUNT];  // 角色包裹中的物品ID
    BYTE m_AssistantAttrib[MAX_BAG_PAGE_COUNT][MAX_BAG_LINE_COUNT]
                          [MAX_BAG_COLUMN_COUNT];  // 辅助属性
...
class CItemContainerBase {
   ...
   public:
    ...
    virtual bool CheckEquip(EEquipParts vPart, SItemID& item,
                            SCreature& cre) const;  // 检查装备道具的需求是否满足
    virtual bool CheckUse(SItemID& item, SCreature& cre) const;  // 检查使用道具的需求是否满足
    bool Equip(SItemID& id, EEquipParts vPart = EQUIP_DEFAULT_PART, bool bRemoveFromBag = false,
               SItemID* pItemUnEquip1 = NULL, EEquipParts* pPartUnEquip1 = NULL,
               SItemID* pItemUnEquip2 = NULL, EEquipParts* pPartUnEquip2 = NULL);
    ...
    int          GetUnEquipItemCount(
                 SItemID& item,
                 EEquipParts vPart = EQUIP_DEFAULT_PART);  // 如果装备item，返回需要脱掉几个装备（0/1/2）
    ...
    bool _IsValidPart(EEquipParts vPart) const {
        return (vPart >= WEAPON_1 && vPart < MAX_EQUIP_PARTS);
    }
    ...
    static bool ExchangeItems(CItemContainerBase* pCon1, vector<SItemID>& arrItems1,
   ...
   protected:
    ...
    virtual void _UpdateCreature(bool bEquip, SItemID& item,
                                 EEquipParts part);  // Equip和UnEquip时调用，调整人物属性
    ...
    CItemManager*
        m_pItemManager;  // 物品管理对象（应该是全局唯一的）                             //
...
void ItemUpdate_GetExtraAddtion(SItemID& item, CItemManager* pItemMgr, float& fDamage,
                                float& fAttack, float& fDodge, float& fArmor, float& fElementArmor);
// 得到打造道具额外增加的需求
...
const float g_itemupdate_successRate[ITEM_MAX_ITEM_LEVEL] = {1.0f,  1.0f,  1.0f,  0.80f, 0.80f,
                                                             0.30f, 0.11f, 0.11f, 0.11f, 0.00f};
const float g_itemupdate_brokenRate[ITEM_MAX_ITEM_LEVEL]  = {0.0f,  0.0f, 0.0f, 0.30f, 0.30f,
                                                             0.30f, 0.6f, 0.6f, 0.6f,  1.0f};
const int   g_itemupdate_moneyRequireWeapon[ITEM_MAX_ITEM_LEVEL] = {1000, 2000, 3000, 3000, 3000,
                                                                    3000, 7000, 8000, 9000, 10000};
const int   g_itemupdate_moneyRequireArmor[ITEM_MAX_ITEM_LEVEL]  = {500,  1000, 1500, 1500, 1500,
                                                                    1500, 3500, 4000, 4500, 5000};
...
// 彩蛋的奖励种类
enum EMagicItemResult { MI_Null, MI_Item, MI_Exp, MI_Money, MI_ALL, MI_SOUL };
...
struct SMagicItemReward {
   public:
    ...
    void AddReward(EMagicItemResult type, double rate, DWORD param, double _GreenRate = 0.0,
                   double _BlueRate = 0.0, double _GoldenRate = 0.0, int MaxCount = 0) {
        CurrHitNum += rate;
        if (CurrHitNum < 0.0)
            CurrHitNum = 0.0;
        if (CurrHitNum > 100.0)
...
enum ETradableResult { TR_Can, TR_CanNot_Unkown, TR_CanNot_Essence, TR_CanNot_Pet };
