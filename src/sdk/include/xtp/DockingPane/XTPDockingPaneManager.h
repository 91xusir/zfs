...
public:
	...
	//     pPane      - Pane to be docked.
	//     direction  - Docking direction. Can be any of the values listed in the Remarks section.
	//     rc - Number of pixels to offset the pane from the inside top edge of the client area.  This only has an effect when using the DockLeftOf and xtpPaneDockRight direction.
	// Remarks:
