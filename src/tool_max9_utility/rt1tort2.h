...
inline bool rtMD5FileString(char* szSource, char* szMD5)
{
	RtMD5 rtMD5;
...
inline bool rtMD5DataString(char* szData, DWORD iLen, char* szMD5)
{
	RtMD5 rtMD5;
...
inline bool rtMD5StringString(char* szString, char* szMD5)
{
	RtMD5 rtMD5;
...
inline void rtMD5PrintString(char * buf, unsigned char*)
{
...
inline void UselessFun(char* pFmt, ...)
{
	return;
}
